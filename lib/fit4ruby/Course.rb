...
# encoding: UTF-8
#
# = FITCourse.rb -- Fit4Ruby - FIT file processing library for Ruby
#
...
module Fit4Ruby
  ...
  class Course < FitDataRecord
    ...
    # Returns the remaining recovery time at the start of the Course.
    ...
    # Returns the predicted recovery time needed after this Course.
    ...
    # Add a new FileId to the Course. It will replace any previously added
    # FileId object.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    # @return [FileId]
    ...
    # Add a new FieldDescription to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    ...
    # Add a new DeveloperDataId to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    ...
    # Add a new FileCreator to the Course. It will replace any previously
    ...
    # Add a new DeviceInfo to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    # @return [DeviceInfo]
    ...
    # Add a new SourceData to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    # @return [SourceData]
    ...
    # Add a new UserData to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    # @return [UserData]
    ...
    # Add a new UserProfile to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    # @return [UserProfile]
    ...
    # Add a new PhysiologicalMetrics to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    ...
    # Add a new Session to the Course. All previously added Lap objects are
    ...
    # Add a new Lap to the Course. All previoulsy added Record objects are
    ...
    # Add a new Length to the Course. All previoulsy added Record objects are
    ...
    # Add a new HeartRateZones record to the Course.
    ...
    # Add a new PersonalRecord to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    ...
    # Add a new Record to the Course.
    # @param field_values [Hash] A Hash that provides initial values for
    #        certain fields of the FitDataRecord.
    # @return [Record]
    ...
    # Check if the current Course is equal to the passed Course.
    # @param a [Course] Course to compare this Course with.
